	...
	<body>
		...
		<h1> Welcome: <?php echo " " . $fname?></h1> <br><br>
		 ...
		 <form action="profile.php" method="post">
			<ul><li><label for="eid">Employee Number: </label></li><?php echo $eid?>
				<li><label for="phone">Phone Number: </label></li><?php echo $phone?>
				<li><label for="jdate">Join Date:</label> </li><?php echo $jdate?>
		...
		<!-- update information --> 
		<input type="submit" name="submit" value="submit" class="btn btn-default btn-xl wow tada">
		
			<br><br>
			<h2>Your Department:</h2><ul>
